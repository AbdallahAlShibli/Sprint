...
//    private Button mButtonChooseImage;
    private Button mButtonUpload, mTextViewShowUploads;
//    private TextView mTextViewShowUploads;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=getSharedPreferences("OmanSoftware", Context.MODE_PRIVATE);
...
//        });
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(getApplication(), ImagesActivity.class);
